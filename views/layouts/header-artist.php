...
<body>
<h2 class="p-3 m-0 bg-primary-subtle">ARTIST BOARD</h2>
<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="mynavbar">
      ...
      <li class="nav-item">
          <a class="nav-link" href="<?= $baseurl ?>/artistboard">Dashboard</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?= $baseurl ?>/songmanager">Songs</a>
        </li>
        <li class="nav-item">
