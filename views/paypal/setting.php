<?php
 ...
 define('PAYPAL_RETURN_URL', 'http://localhost/PRO1014/Assignments/Melodies/views/paypal/success.php');
 define('PAYPAL_CANCEL_URL', 'http://localhost/PRO1014/Assignments/Melodies/views/paypal/cancel.php');
